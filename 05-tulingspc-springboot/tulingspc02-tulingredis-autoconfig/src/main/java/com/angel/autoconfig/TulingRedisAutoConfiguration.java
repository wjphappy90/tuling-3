package com.angel.autoconfig;

import com.angel.core.ITulingRedis;
import com.angel.core.TulingRedisClient;
...
public class TulingRedisAutoConfiguration {
    ...
    public JedisPool jedisPool() {
        ...
        JedisPool  jedisPool = new JedisPool(jedisPoolConfig,tulingRedisProperties.getHost(), tulingRedisProperties.getPort(),tulingRedisProperties.getTimeOut(),null);
        return jedisPool;
    }
